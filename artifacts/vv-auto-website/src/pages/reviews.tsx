  ...
  return (
    <a
      ...
      className={[
        ...
        live
          ? "bg-white border-gray-200 text-gray-600 shadow-sm cursor-pointer hover:border-[#4285F4] hover:text-[#4285F4] hover:shadow group"
    ...
    >
      ...
      {live && (
        <ExternalLink size={9} className="text-gray-400 group-hover:text-[#4285F4] transition-colors shrink-0" />
      )}
    </a>
  );
}
