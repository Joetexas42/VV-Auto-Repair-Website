...
function GoogleBadge({ live }: { live: boolean }) {
  return (
    <a
      ...
      className={[
        "inline-flex items-center gap-1.5 mt-2 px-2.5 py-1 rounded-full border text-xs font-semibold transition-all",
        live
          ? "bg-white/15 border-white/25 text-white/80 cursor-pointer hover:bg-white/25 hover:border-white/40 hover:text-white group"
    ...
    >
      ...
      {live && (
        <ExternalLink size={9} className="text-white/50 group-hover:text-white/80 transition-colors shrink-0" />
      )}
    </a>
  );
}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <div className="bg-white border-2 border-[var(--vv-gray)] rounded-2xl p-8 lg:p-10 shadow-lg relative overflow-hidden group">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <a href="https://www.google.com/maps/place/V+V+Auto+Body+Repair+Corporation/@32.9016826,-96.6874462,17z/data=!3m1!4b1!4m6!3m5!1s/g/11pzygbgln!8m2!3d32.9016826!4d-96.6874462!16s%2Fg%2F11pzygbgln!9m1!1b1" target="_blank" rel="noreferrer" className="flex-1 bg-[var(--vv-teal)] hover:bg-teal-400 text-white text-center py-3 rounded-lg font-bold transition-colors">
                  {t("Get Directions", "Chỉ Đường")}
                </a>
              </div>
            </div>
